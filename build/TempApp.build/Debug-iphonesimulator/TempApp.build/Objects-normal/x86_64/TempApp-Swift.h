...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TempApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7TempApp11AppDelegate")
...
SWIFT_CLASS("_TtC7TempApp13SceneDelegate")
...
SWIFT_CLASS("_TtC7TempApp21WeatherViewController")
@interface WeatherViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified conditionImageView;
...
@interface WeatherViewController (SWIFT_EXTENSION(TempApp)) <CLLocationManagerDelegate>
- (IBAction)locationPressed:(UIButton * _Nonnull)sender;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didUpdateLocations:(NSArray<CLLocation *> * _Nonnull)locations;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didFailWithError:(NSError * _Nonnull)error;
@end


@interface WeatherViewController (SWIFT_EXTENSION(TempApp)) <UITextFieldDelegate>
- (IBAction)searchPressed:(UIButton * _Nonnull)sender;
